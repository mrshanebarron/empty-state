<div style="text-align: center; padding: 3rem 1.5rem;">
    @if($icon)
        <div style="margin: 0 auto 1rem; width: 3rem; height: 3rem; color: #9ca3af;">{!! $icon !!}</div>
    @else
    ...
    <h3 style="font-size: 1.125rem; font-weight: 500; color: #111827; margin-bottom: 0.25rem;">{{ $title }}</h3>

    @if($description)
        <p style="font-size: 0.875rem; color: #6b7280; margin-bottom: 1rem;">{{ $description }}</p>
    @endif
